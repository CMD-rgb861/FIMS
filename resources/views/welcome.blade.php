...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen bg-slate-50 text-slate-900">
        @php
            ...
            $selectedTerm = request('term', $terms[0]['value'] ?? 'all');
        ...
        <div class="min-h-screen flex">
            <aside class="hidden md:flex w-72 bg-white border-r border-slate-200 flex-col">
                <div class="h-16 px-6 flex items-center gap-3 border-b border-slate-200">
                    <div class="h-9 w-9 rounded-lg bg-blue-600 text-white flex items-center justify-center font-semibold">F</div>
                    <div class="leading-tight">
                        <div class="font-semibold">Dashboard</div>
                        <div class="text-xs text-slate-500">{{ config('app.name', 'FIMS') }}</div>
                    </div>
                </div>

                <nav class="flex-1 p-3 space-y-1">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-700 hover:bg-slate-100">
                        <span class="h-8 w-8 rounded-lg bg-slate-100 flex items-center justify-center text-slate-600">
                    ...
                    <a href="#" class="flex items-center justify-between gap-3 px-3 py-2 rounded-lg text-slate-700 hover:bg-slate-100">
                    ...
                    <a href="#" class="flex items-center justify-between gap-3 px-3 py-2 rounded-lg text-slate-700 hover:bg-slate-100">
                        <span class="flex items-center gap-3">
                            ...
                            <span class="text-sm font-medium">Pre-Enrollment</span>
                        </span>
                        <svg viewBox="0 0 24 24" class="h-4 w-4 text-slate-400" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="m9 18 6-6-6-6" />
                        </svg>
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-blue-50 text-blue-700">
                        <span class="h-8 w-8 rounded-lg bg-blue-100 flex items-center justify-center text-blue-700">
                            <svg viewBox="0 0 24 24" class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="pt-4">
                        <div class="px-3 text-[11px] font-semibold tracking-wide text-slate-400 uppercase">Additional Settings</div>
                ...
                <div class="p-4 border-t border-slate-200">
                    <div class="flex items-center gap-3">
                        <div class="h-10 w-10 rounded-full bg-slate-900 text-white flex items-center justify-center text-sm font-semibold">U</div>
                        <div class="min-w-0">
                            <div class="text-sm font-semibold truncate">Student</div>
                            <div class="text-xs text-slate-500 truncate">1000000</div>
                        </div>
            ...
            <main class="flex-1">
                <div class="h-16 bg-white border-b border-slate-200 flex items-center px-6">
                    <div class="text-sm text-slate-500 flex items-center gap-2">
                        <a href="{{ route('dashboard') }}" class="hover:text-slate-700">Home</a>
                        <span class="text-slate-300">›</span>
                        <span>Student</span>
                        <span class="text-slate-300">›</span>
                        <span class="text-slate-700 font-medium">My Evaluation</span>
                    </div>
                </div>

                <div class="p-6">
                    <div>
                        <h1 class="text-2xl font-semibold tracking-tight">My Evaluation</h1>
                    ...
                    <form method="GET" action="{{ route('dashboard') }}" class="mt-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-3 max-w-3xl">
                            <label class="block">
                                ...
                                <select name="sy" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                                    @foreach ($schoolYears as $option)
                                        <option value="{{ $option['value'] }}" @selected($selectedSchoolYear === $option['value'])>{{ $option['label'] }}</option>
                                    @endforeach
                                </select>
                            </label>
                            ...
                            <label class="block">
                                ...
                                <select name="term" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                                    @foreach ($terms as $option)
                                        <option value="{{ $option['value'] }}" @selected($selectedTerm === $option['value'])>{{ $option['label'] }}</option>
                                    @endforeach
                                </select>
                            </label>
                            ...
                            <label class="block">
                                ...
                                <select name="subject" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                                    @foreach ($subjects as $option)
                                        <option value="{{ $option['value'] }}" @selected($selectedSubject === $option['value'])>{{ $option['label'] }}</option>
                                    @endforeach
                                </select>
                            </label>
                        </div>
                            ...
                            <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-4">
                                <div class="flex items-start justify-between gap-4">
                                    <div class="flex items-start gap-3 min-w-0">
                                        <div class="h-10 w-10 rounded-full bg-blue-600/10 text-blue-700 flex items-center justify-center text-sm font-semibold shrink-0">
                                            {{ $item['initials'] }}
                                        </div>
                                        <div class="min-w-0">
                                            ...
                                            <div class="mt-1 text-xs text-slate-500 truncate">Instructor: {{ $item['instructor'] }}</div>
                                            <div class="mt-1 text-xs text-slate-500 truncate">Term: {{ $item['term'] }}</div>
                                        </div>
                                    </div>
                                    <div class="shrink-0">
                                        <a href="#" class="inline-flex items-center rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-50">
                                            EVALUATE
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    <a href="#" class="inline-flex items-center rounded-md bg-blue-600 px-3 py-2 text-xs font-semibold text-white hover:bg-blue-700">
                                        Start Evaluation
                                    </a>
                                </div>
                            </div>
