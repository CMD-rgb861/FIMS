            ...
            <div className="w-full max-w-4xl rounded-2xl border border-slate-300 bg-white shadow-2xl">
                ...
                <div className="flex justify-end gap-2 border-t border-slate-200 px-5 py-4">
                    ...
                    <button
                        ...
                        className="inline-flex items-center rounded-md bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {isGenerating ? (
                            <>
